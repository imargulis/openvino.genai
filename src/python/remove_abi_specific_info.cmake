...
foreach(file_line IN LISTS file_lines)
    ...
    if(file_line MATCHES "^from openvino_genai\\.py_openvino_genai\\..* import selector_model$")
        set(file_line "from openvino_genai.py_openvino_genai import selector_model")
    endif()
